...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    # Make sidebar autoscroll with main panel   
    ...
    mainPanel(
      ...
      #    tabPanel(
                 ...
                 fluidRow(
                   ...
                   p(""),
                   p("The data used here come from surveys of carbon in soils, trees and dead-wood in Mexicos mangrove forests. The surveys covered Mexico's three major climate regions."),
